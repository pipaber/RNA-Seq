...
\hypersetup{
  pdftitle={Analysis of RNA-Seq Data},
  pdfauthor={Piero Palacios Bernuy},
  pdfkeywords={RNA, reads, gene expression, gene sets, ontologies},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
data in the context of differentially gene expression and gene-sets.
\end{abstract}
